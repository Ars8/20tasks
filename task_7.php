    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        $elements = [
            [
                "name" => "oliver",
                "surname" => "kopyov",
                "subtitle" => "IT Director, Gotbootstrap Inc.",
            ...
            [
                "name" => "sesha",
                "surname" => "gray",
                "subtitle" => "Project Manager, Gotbootstrap Inc.",
            ...
            [
                "name" => "dr john",
                "surname" => "cook",
                "subtitle" => "Human Resources, Gotbootstrap Inc.",
            ...
            [
                "name" => "jim",
                "surname" => "ketty",
                "subtitle" => "Staff Orgnizer, Gotbootstrap Inc.",
            ...
            [
                "name" => "aaron",
                "surname" => "tellus",
                "subtitle" => "Oncologist, Gotbootstrap Inc.",
            ...
            [
                "name" => "sarah",
                "surname" => "mcbrook",
                "subtitle" => "Xray Division, Gotbootstrap Inc.",
            ...
            [
                "name" => "jimmy",
                "surname" => "fellan",
                "subtitle" => "Accounting, Gotbootstrap Inc.",
        ...
        <div class="row js-list-filter" id="js-contacts">
            ...
            <?php foreach ($elements as $element) : ?>
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $element['name'] .' '. $element['surname'] ;?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $element['status'] ;?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/avatar-<?php echo $element['avatar'] ;?>.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo ucfirst($element['name']) .' '. ucfirst($element['surname']) ;?>
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $element['subtitle'] ;?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $element['phoneNumber'] ;?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $element['email'] ;?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $element['address'] ;?>
                                </address>
